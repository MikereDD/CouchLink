# CouchLink v1.3 Release Checklist

## Version and source

- [ ] Android reports `1.3` with `versionCode 141`.
- [ ] Windows Host reports `1.3`.
- [ ] Source manifest verification passes.
- [ ] README screenshot gallery renders correctly on Forgejo and GitHub.
...
- [ ] v1.3-rc.1 upgrades to v1.3 without losing settings.
...
- [ ] Windows release package launches from a clean test location.
- [ ] SHA-256 files are generated and verified for APK, Windows package, and source ZIP.
- [ ] Final release notes and artifact names consistently use `v1.3`.
