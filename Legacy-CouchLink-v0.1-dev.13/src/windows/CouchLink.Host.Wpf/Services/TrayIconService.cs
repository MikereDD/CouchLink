...
public sealed class TrayIconService : IDisposable
{
    ...
    private readonly Func<bool> _inputEnabled;
    private readonly Action _exitApplication;

    public TrayIconService(Action showWindow, Action toggleInput, Func<bool> inputEnabled, Action exitApplication)
    {
        ...
        menu.Items.Add("Toggle Remote Input", null, (_, _) => _toggleInput());
