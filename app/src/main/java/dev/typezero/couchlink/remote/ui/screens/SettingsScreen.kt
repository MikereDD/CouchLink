...
internal fun SettingsScreen(
    ...
    val diagnostics = remember(hidState, buildChannel) {
        buildString {
    ...
    PremiumPanel {
        ...
        Text(
            text = "CouchLink sends keyboard and mouse reports directly over Bluetooth. " +
                "No Windows companion app or cloud service is required.",
            color = Muted,
            fontSize = 11.sp,
        )
    }
